...
@router.get("/", response_model=list[CategoryOut], summary="Lister toutes les categories")
def list_categories(db: Session = Depends(get_db)):
    return category_service.get_all_categories(db)


@router.get("/{category_id}", response_model=CategoryOut, summary="Obtenir une categorie par ID")
